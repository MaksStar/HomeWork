...
public class CoffeeMachine {
    public static void main(String[] args) {
        ...
        if (choice == 1) {
            System.out.println("Вы выбрали эспрессо: " + machinedOne.cof1());
        } else if (choice == 2)
            System.out.println("Вы выбрали американно: " + machinedOne.cof2());
        else if (choice == 3)
            System.out.println("Вы выбрали капучино: " + machinedOne.cof3());
        else if (choice == 4)
